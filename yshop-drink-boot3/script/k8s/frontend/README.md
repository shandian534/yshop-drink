...
# 2. 复制构建文件
cp /root/yshop-drink-boot3/script/k8s/frontend/Dockerfile .
cp /root/yshop-drink-boot3/script/k8s/frontend/nginx.conf .
cp /root/yshop-drink-boot3/script/k8s/frontend/.dockerignore .
